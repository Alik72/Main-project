...
/**
 * Created by Homosapiens on 21.03.2016.
 */
public class ClassCreationTests1 {
  FirefoxDriver wd;
  ...
  public void testClassCreation() {
    ...
    wd.findElement(By.xpath("//div[@id='ufd-container']/div[1]//li[2]")).click();
    if (!wd.findElement(By.xpath("//select[@id='ufd-fSECURITY_ID']//option[2]")).isSelected()) {
      wd.findElement(By.xpath("//select[@id='ufd-fSECURITY_ID']//option[2]")).click();
    }
